...
function ContactsModal({ isOpenContactsModal, onCloseContactsModal }) {
  if (!isOpenContactsModal) return null // если модалка закрыта — ничего не рендерим

  return (
    <div
      className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50"
      onClick={onCloseContactsModal} // клик по фону = закрытие
    >
      <div
